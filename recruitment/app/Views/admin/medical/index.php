    ...
    <aside class="admin-sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li><a href="<?= url('/admin/medical') ?>" class="nav-link active"><i class="fas fa-heartbeat"></i><span>Medical</span></a></li>
                <?php endif; ?>
            </ul>
        </nav>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if (!empty($mcu['hospital_address'])): ?>
                                                    <br><small class="text-muted"><?= htmlspecialchars($mcu['hospital_address']) ?></small>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <?php if (!empty($mcu['result'])): ?>
                                                    <span class="badge badge-<?= $mcu['result'] === 'fit' ? 'success' : ($mcu['result'] === 'unfit' ? 'danger' : 'warning') ?>">
                                                        <?= ucfirst($mcu['result']) ?>
                                                    </span>
                                                <?php else: ?>
