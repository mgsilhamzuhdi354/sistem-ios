        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <?php else: ?>
                    ...
                    <li><a href="<?= url('/admin/interviews') ?>" class="nav-link active"><i
                                class="fas fa-robot"></i><span>AI Interviews</span></a></li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($session['total_score'] !== null): ?>
                                                            <strong class="score"><?= $session['total_score'] ?></strong><span
                                    ...
                                    <?php foreach ($questionBanks as $bank): ?>
                                        <div class="bank-card">
                                            <div class="bank-header">
                                                ...
                                                <span class="question-count"><?= $bank['question_count'] ?? 0 ?>
                                                    questions</span>
                                            </div>
                                            <p class="bank-desc">
                                                <?= htmlspecialchars($bank['description'] ?? 'No description') ?></p>
                                            <div class="bank-meta">
                                                <span><i class="fas fa-clock"></i> <?= $bank['time_limit_minutes'] ?? 30 ?>
                                                    min</span>
                                                <span
                                                    class="badge badge-<?= !empty($bank['is_active']) ? 'success' : 'secondary' ?>">
