    ...
    <aside class="admin-sidebar" id="sidebar">
        <div class="sidebar-header">
            <a href="<?= url('/master-admin') ?>" class="logo">
                <img src="<?= asset('images/logo.jpg') ?>" alt="Indo Ocean"
        ...
        <nav class="sidebar-nav">
            ...
            <ul>
                <li class="nav-item">
                    <a href="<?= url('/master-admin/dashboard') ?>"
                        class="nav-link <?= strpos($uri, '/master-admin/dashboard') !== false ? 'active' : '' ?>">
            ...
            <div class="nav-section <?= $isUsersSection ? 'open' : '' ?>">
                ...
                <ul class="nav-submenu">
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/users') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/users') !== false && strpos($uri, '/online') === false ? 'active' : '' ?>">
                            <i class="fas fa-users-cog"></i>
                            <span>Manajemen User</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/users/online') ?>"
                            class="nav-link <?= strpos($uri, '/users/online') !== false ? 'active' : '' ?>">
            ...
            <div class="nav-section <?= $isRecruitmentSection ? 'open' : '' ?>">
                ...
                <ul class="nav-submenu">
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/vacancies') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/vacancies') !== false ? 'active' : '' ?>">
                            <i class="fas fa-briefcase"></i>
                            <span>Lowongan Kerja</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/pipeline') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/pipeline') !== false ? 'active' : '' ?>">
                            <i class="fas fa-stream"></i>
                            <span>Pipeline</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/requests') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/requests') !== false ? 'active' : '' ?>">
            ...
            <div class="nav-section <?= $isApplicationsSection ? 'open' : '' ?>">
                ...
                <ul class="nav-submenu">
                    ...
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/archive') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/archive') !== false ? 'active' : '' ?>">
                            <i class="fas fa-archive"></i>
                            <span>Arsip</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/recruitment-report') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/recruitment-report') !== false ? 'active' : '' ?>">
            ...
            <div class="nav-section <?= $isSystemSection ? 'open' : '' ?>">
                ...
                <ul class="nav-submenu">
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/reports') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/reports') !== false ? 'active' : '' ?>">
                            <i class="fas fa-chart-bar"></i>
                            <span>Laporan</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/settings') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/settings') !== false ? 'active' : '' ?>">
                            <i class="fas fa-cog"></i>
                            <span>Pengaturan</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/departments') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/departments') !== false ? 'active' : '' ?>">
                            <i class="fas fa-building"></i>
                            <span>Departemen</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/vessel-types') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/vessel-types') !== false ? 'active' : '' ?>">
                            <i class="fas fa-ship"></i>
                            <span>Tipe Kapal</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/email-settings') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/email-settings') !== false ? 'active' : '' ?>">
                            <i class="fas fa-envelope"></i>
                            <span>Email</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/permissions') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/permissions') !== false ? 'active' : '' ?>">
                            <i class="fas fa-shield-alt"></i>
                            <span>Hak Akses</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= url('/master-admin/profile') ?>"
                            class="nav-link <?= strpos($uri, '/master-admin/profile') !== false ? 'active' : '' ?>">
