...
.profile-header { background: linear-gradient(135deg, #2d3748 0%, #4a5568 100%); border-radius: 16px; padding: 2rem; color: white; margin-bottom: 2rem; display: flex; align-items: center; gap: 2rem; }
...
.avatar-upload-btn { position: absolute; bottom: 0; right: 0; width: 36px; height: 36px; background: #38a169; border: 3px solid white; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; cursor: pointer; }
...
.btn-save { background: linear-gradient(135deg, #38a169, #2f855a); color: white; border: none; padding: 0.75rem 2rem; border-radius: 8px; font-weight: 600; cursor: pointer; }
...
<div class="profile-container">
    <div class="profile-header">
        ...
        <div class="profile-info">
            ...
            <span class="role-badge"><i class="fas fa-users me-1"></i> Leader</span>
        </div>
    </div>
    
    <div class="profile-card">
        <div class="profile-card-header"><i class="fas fa-user text-success"></i> Personal Information</div>
        <div class="profile-card-body">
            <form action="<?= url('/leader/profile/update') ?>" method="POST">
                <?= csrf_field() ?>
                <div class="row">
    ...
    <div class="profile-card">
        ...
        <div class="profile-card-body">
            <form action="<?= url('/leader/profile/change-password') ?>" method="POST">
                <?= csrf_field() ?>
                <div class="row">
...
document.getElementById('avatarInput').addEventListener('change', function(e) {
    ...
    fetch('<?= url('/leader/profile/avatar') ?>', { method: 'POST', body: formData })
    .then(r => r.json())
