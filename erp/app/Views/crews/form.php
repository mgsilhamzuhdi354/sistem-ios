    ...
    <div class="grid-2" style="gap: 24px;">
        ...
        <div class="card">
            ...
            <div class="form-group" style="margin-bottom: 16px;">
                ...
                <input type="text" class="form-control" value="<?= htmlspecialchars($employeeId ?? '') ?>" disabled
            ...
            <div class="form-group" style="margin-bottom: 16px;">
                ...
                <input type="text" name="full_name" class="form-control"
                    value="<?= htmlspecialchars($crew['full_name'] ?? '') ?>" required>
            </div>
            ...
            <div class="grid-2" style="gap: 16px;">
                ...
                <div class="form-group" style="margin-bottom: 16px;">
                    ...
                    <select name="gender" class="form-control">
                        <option value="male" <?= ($crew['gender'] ?? 'male') === 'male' ? 'selected' : '' ?>>Laki-laki
                        </option>
                        <option value="female" <?= ($crew['gender'] ?? '') === 'female' ? 'selected' : '' ?>>Perempuan
                        </option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid-2" style="gap: 16px;">
                ...
                <div class="form-group" style="margin-bottom: 16px;">
                    ...
                    <select name="religion" class="form-control">
                        ...
                        <option value="Kristen" <?= ($crew['religion'] ?? '') === 'Kristen' ? 'selected' : '' ?>>Kristen
                        </option>
                        <option value="Katolik" <?= ($crew['religion'] ?? '') === 'Katolik' ? 'selected' : '' ?>>Katolik
                        </option>
                        <option value="Hindu" <?= ($crew['religion'] ?? '') === 'Hindu' ? 'selected' : '' ?>>Hindu</option>
                        <option value="Buddha" <?= ($crew['religion'] ?? '') === 'Buddha' ? 'selected' : '' ?>>Buddha
                        </option>
                        <option value="Konghucu" <?= ($crew['religion'] ?? '') === 'Konghucu' ? 'selected' : '' ?>>Konghucu
                        </option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group" style="margin-bottom: 16px;">
                ...
                <select name="marital_status" class="form-control">
                    <option value="single" <?= ($crew['marital_status'] ?? 'single') === 'single' ? 'selected' : '' ?>>
                        Belum Menikah</option>
                    <option value="married" <?= ($crew['marital_status'] ?? '') === 'married' ? 'selected' : '' ?>>Menikah
                    </option>
                    <option value="divorced" <?= ($crew['marital_status'] ?? '') === 'divorced' ? 'selected' : '' ?>>Cerai
                    </option>
                    <option value="widowed" <?= ($crew['marital_status'] ?? '') === 'widowed' ? 'selected' : '' ?>>
                        Duda/Janda</option>
                </select>
            </div>
        ...
        <div class="card">
            ...
            <div class="form-group" style="margin-bottom: 16px;">
                ...
                <textarea name="address" class="form-control"
                    rows="2"><?= htmlspecialchars($crew['address'] ?? '') ?></textarea>
            </div>
            ...
            <h4 style="margin-bottom: 16px;"><i class="fas fa-exclamation-triangle" style="color: var(--warning);"></i>
                Kontak Darurat</h4>
        ...
        <div class="card">
            ...
            <div class="form-group" style="margin-bottom: 16px;">
                ...
                <input type="text" name="bank_name" class="form-control"
                    value="<?= htmlspecialchars($crew['bank_name'] ?? '') ?>" placeholder="BCA, Mandiri, BNI, dll">
            </div>
        ...
        <div class="card">
            ...
            <div class="form-group" style="margin-bottom: 16px;">
                ...
                <select name="status" class="form-control">
                    <option value="available" <?= ($crew['status'] ?? 'available') === 'available' ? 'selected' : '' ?>>
                        Available</option>
                    <option value="onboard" <?= ($crew['status'] ?? '') === 'onboard' ? 'selected' : '' ?>>On Board
                    </option>
                    <option value="standby" <?= ($crew['status'] ?? '') === 'standby' ? 'selected' : '' ?>>Standby</option>
                    <option value="terminated" <?= ($crew['status'] ?? '') === 'terminated' ? 'selected' : '' ?>>Terminated
                    </option>
                </select>
            </div>
            ...
            <div class="form-group" style="margin-bottom: 16px;">
                ...
                <textarea name="notes" class="form-control"
                    rows="3"><?= htmlspecialchars($crew['notes'] ?? '') ?></textarea>
            </div>
        </div>
    </div>
