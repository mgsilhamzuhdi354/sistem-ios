                ...
                <div class="flex items-start gap-5">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-2 mt-2">
                            ...
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-semibold <?= $user['is_active'] ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700' ?>"><?= $user['is_active'] ? 'Active' : 'Inactive' ?></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden opacity-0 animate-fade-in animate-d1">
                    <div class="px-5 py-3 border-b border-slate-100 flex items-center gap-2">
                        ...
                        <h3 class="text-sm font-bold text-slate-800">Login History</h3>
                    </div>
                    <div class="overflow-x-auto max-h-80 overflow-y-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                ...
                                <tr><td colspan="3" class="px-4 py-6 text-center text-sm text-slate-400">No login history</td></tr>
                                <?php else: ?>
                ...
                <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden opacity-0 animate-fade-in animate-d2">
                    <div class="px-5 py-3 border-b border-slate-100 flex items-center gap-2">
                        ...
                        <h3 class="text-sm font-bold text-slate-800">Activity Log</h3>
                    </div>
                    <div class="overflow-x-auto max-h-80 overflow-y-auto">
                        <table class="w-full">
                            <thead class="sticky top-0"><tr class="bg-slate-50 border-b border-slate-200">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                ...
                                <tr><td colspan="3" class="px-4 py-6 text-center text-sm text-slate-400">No activities</td></tr>
                                <?php else: ?>
