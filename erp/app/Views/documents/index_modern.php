...
<head>
    ...
    <title>Manajemen Dokumen | IndoOcean ERP</title>
        ...
        <main class="ml-64 flex-1 flex flex-col min-w-0 overflow-hidden bg-slate-50">
            ...
            <header class="h-16 bg-white border-b border-slate-200 px-8 flex items-center justify-between z-10 flex-shrink-0 shadow-sm">
                ...
                <div class="flex items-center gap-2 text-sm">
                    ...
                    <span class="text-gray-800 dark:text-white font-semibold">Manajemen Dokumen</span>
                </div>
                ...
                <div class="max-w-7xl mx-auto space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="bg-surface-light dark:bg-surface-dark p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center justify-between group hover:shadow-md transition-shadow">
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Valid</p>
                        ...
                        <div class="bg-surface-light dark:bg-surface-dark p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center justify-between group hover:shadow-md transition-shadow">
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Segera Berakhir</p>
                        ...
                        <div class="bg-surface-light dark:bg-surface-dark p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center justify-between group hover:shadow-md transition-shadow">
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Expired</p>
                        ...
                        <div class="bg-surface-light dark:bg-surface-dark p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center justify-between group hover:shadow-md transition-shadow">
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Total Dokumen</p>
                        ...
                        <div class="bg-surface-light dark:bg-surface-dark rounded-xl border-l-4 border-red-500 shadow-sm overflow-hidden">
                            <div class="p-6">
                                <h4 class="text-lg font-bold text-red-600 dark:text-red-400 mb-4 flex items-center">
                                    ...
                                    Dokumen Expired (<?= count($expired) ?>)
                                </h4>
                                <div class="overflow-x-auto">
                                    <table class="w-full">
                                        <thead>
                                            <tr class="bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700">
                                                <th class="py-3 px-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Crew</th>
                                                <th class="py-3 px-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Dokumen</th>
                                                <th class="py-3 px-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Tipe</th>
                                                <th class="py-3 px-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Expired Pada</th>
                                                <th class="py-3 px-4 text-right text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Aksi</th>
                                            </tr>
                                        </thead>
                        ...
                        <div class="bg-surface-light dark:bg-surface-dark rounded-xl border-l-4 border-yellow-500 shadow-sm overflow-hidden">
                            <div class="p-6">
                                <h4 class="text-lg font-bold text-yellow-600 dark:text-yellow-400 mb-4 flex items-center">
                                    ...
                                    Akan Expired dalam 90 Hari (<?= count($expiring) ?>)
                                </h4>
                                <div class="overflow-x-auto">
                                    <table class="w-full">
                                        <thead>
                                            <tr class="bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700">
                                                ...
                                                <th class="py-3 px-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Dokumen</th>
                                                <th class="py-3 px-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Tipe</th>
                                                <th class="py-3 px-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Berakhir Pada</th>
                                                <th class="py-3 px-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Sisa Hari</th>
                                                <th class="py-3 px-4 text-right text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Aksi</th>
                                            </tr>
                                        </thead>
                                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                            <?php foreach ($expiring as $doc): ?>
                                                ...
                                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                                    ...
                                                    <td class="py-4 px-4">
                                                        <span class="text-sm font-bold <?= $urgencyColor ?>"><?= $daysLeft ?> hari</span>
                                                    </td>
                                                    <td class="py-4 px-4 text-right">
                                                        <a href="<?= BASE_URL ?>documents/<?= $doc['crew_id'] ?>" 
                                                           class="inline-flex items-center px-3 py-1.5 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors text-sm font-medium">
                    ...
                    <?php if (empty($expired) && empty($expiring)): ?>
                        <div class="bg-surface-light dark:bg-surface-dark rounded-2xl border border-gray-200 dark:border-gray-700 p-12 flex flex-col items-center justify-center text-center shadow-sm min-h-[400px]">
                            ...
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Semua Dokumen Valid!</h2>
                            <p class="text-gray-500 dark:text-gray-400 max-w-md">
                                Tidak ada dokumen yang expired atau akan expired dalam 90 hari. Semua dokumen dalam kondisi baik.
                            </p>
